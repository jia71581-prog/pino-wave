#!/bin/bash
# r19 smoke: verify continue-frequency init + frequency-softmax end-to-end.
cd /root/autodl-tmp/work/FNO-Acoustic-Wave-Simulation/grouped-dual-head-v2
python3 scripts/diagnose_capacity_ladder_overfit.py \
  --artifact-dir results/wkb96_freqsoftmax_r19_smoke_20260824 \
  ...
  --split train --seed 372 2>&1 | tail -25
