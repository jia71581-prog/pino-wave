#!/usr/bin/env python3
"""Measure train-only oracle capacity of the learned PyramidMoE correction span."""
...
def main() -> int:
    ...
    started = time.time()
    identity = {
        "schema": "transfer_dg_pyramid_basis_oracle_cpu_identity_v1",
        "pid": os.getpid(),
        "device": "cpu",
    ...
    try:
        ...
        parent, raw_basis, _ = predict_and_build_basis(model, public)
        del model
        gc.collect()
        ...
        report = {
            "schema": "transfer_dg_pyramid_basis_oracle_cpu_report_v1",
            "status": "complete",
        ...
        atomic_json(
            {
                "schema": "transfer_dg_pyramid_basis_oracle_cpu_terminal_v1",
                "status": "complete",
