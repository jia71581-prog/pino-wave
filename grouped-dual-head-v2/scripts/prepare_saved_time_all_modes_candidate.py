#!/usr/bin/env python3
"""Materialize a 101-mode pilot from the best comparable completed pilot."""
...
def main(argv=None) -> int:
    ...
    report = {
        "schema": "saved_time_all_modes_parent_selection_v1",
        "name": selection.name,
        ...
        "source_modes": int(selection.config.get("variant_overrides", {}).get("modes", 32)),
        "target_modes": 101,
    }
