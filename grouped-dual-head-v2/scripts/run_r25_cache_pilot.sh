...
OUT="$ROOT/results/r25_coarse_residual_pilot_cache_20260828"
MANIFEST="$ROOT/results/r25_coarse_residual_manifest_20260828.json"
...
if [[ "$status" -ne 0 ]]; then
  echo "R25 cache generation failed; inspect worker logs" >&2
  exit "$status"
fi
