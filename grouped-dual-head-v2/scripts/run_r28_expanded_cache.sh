...
OUT="$ROOT/results/r28_expanded_cache_20260828"
MANIFEST="$ROOT/results/r28_expanded_manifest_20260828.json"
...
if [[ "$status" -ne 0 ]]; then
  echo "R28 cache generation failed; inspect worker logs" >&2
  exit "$status"
fi
