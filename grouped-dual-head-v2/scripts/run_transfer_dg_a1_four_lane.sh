...
cd "$ROOT" || exit 1
PREREG=$1
SUPERVISOR=results/transfer_dg_a1_supervisor_20260902
ARMS=(halo halo control control)
SEEDS=(372 733 372 733)
LABELS=(halo_s372 halo_s733 control_s372 control_s733)
CHECKPOINTS=(
...
for label in "${LABELS[@]}"; do
  output="results/transfer_dg_a1_${label}_20260902"
...
for gpu in 0 1 2 3; do
  ...
  output="results/transfer_dg_a1_${label}_20260902"
  env CUDA_VISIBLE_DEVICES=$gpu python scripts/train_transfer_dg_a1_boundary_halo.py \
...
python scripts/summarize_transfer_dg_a1.py \
  --lane-terminal results/transfer_dg_a1_halo_s372_20260902/terminal.json \
  --lane-terminal results/transfer_dg_a1_halo_s733_20260902/terminal.json \
  --lane-terminal results/transfer_dg_a1_control_s372_20260902/terminal.json \
  --lane-terminal results/transfer_dg_a1_control_s733_20260902/terminal.json \
