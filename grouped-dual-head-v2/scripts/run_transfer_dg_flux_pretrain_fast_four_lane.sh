...
cd "$ROOT" || exit 1
PREREG=$1
SUPERVISOR=results/transfer_dg_flux_pretrain_fast_supervisor_20260902
...
for label in "${LABELS[@]}"; do
  output="results/transfer_dg_flux_pretrain_fast_${label}_20260902"
...
python scripts/summarize_transfer_dg_flux_pretrain.py \
  --lane-terminal results/transfer_dg_flux_pretrain_fast_dg_flux_s372_20260902/terminal.json \
  --lane-terminal results/transfer_dg_flux_pretrain_fast_dg_flux_s733_20260902/terminal.json \
  --lane-terminal results/transfer_dg_flux_pretrain_fast_control_s372_20260902/terminal.json \
  --lane-terminal results/transfer_dg_flux_pretrain_fast_control_s733_20260902/terminal.json \
